function [ydata, cost] = tsne_p(P, labels, no_dims, max_iter, epsilon)
...
%         Used to build the same 2D map across many executions
%         global rnd;
%         ydata = .0001 * rnd;
    end
