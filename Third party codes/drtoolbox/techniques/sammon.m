function [y, E, iter] = sammon(x, n, opts)
...
% (C) Laurens van der Maaten, Delft University of Technology
    ...
    if nargin < 3
        ...
        opts.Input          = 'raw';
        opts.MaxHalves      = 20;
        opts.MaxIter        = 1000; % @oliveirafhm mod
        opts.TolFun         = 1e-9;
        opts.Initialisation = 'pca'; % @oliveirafhm mod
        opts.LearningRate   = 0.5; % @oliveirafhm mod
    end
    ...
    for iter=1:opts.MaxIter
        ...
        for j=1:opts.MaxHalves
            ...
            if E_new < E
                ...
                % @oliveirafhm mod
                s = opts.LearningRate*s; % Magic Factor (MF) = 0.5 - Similar the learning rate
            end
        end
